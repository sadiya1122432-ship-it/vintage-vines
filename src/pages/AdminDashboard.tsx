...
export default function AdminDashboard() {
  ...
  const openModal = (product: Product | null = null) => {
    if (product) {
      ...
      setFormData({ title: "", description: "", price: "", imageUrl: "", isPremium: false });
    }
    setIsModalOpen(true);
  };
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 gap-6">
            {products.map((product) => (
              <div key={product.id} className="bg-white rounded-2xl border border-stone-200 overflow-hidden shadow-sm flex flex-col">
                <div className="aspect-video relative overflow-hidden bg-stone-100 flex items-center justify-center p-4">
                  <img 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="md:col-span-2 space-y-2">
              ...
              <div className="p-4 bg-amber-50 border border-amber-100 rounded-xl space-y-2">
                ...
                <p className="text-xs text-amber-700 leading-relaxed">
                  3. Tip: To see product images in your Sheet, use the formula <span className="font-mono font-bold bg-white px-1 rounded">=IMAGE("URL")</span> in a cell.
                </p>
              </div>
            </div>
            <div className="md:col-span-2 space-y-2">
              ...
              <div className="p-6 sm:p-8 space-y-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <p className="text-[10px] text-stone-400 italic">
                          Tip: For Amazon images, use the high-res link (usually ends in .jpg or .png).
                        </p>
                      </div>
                    </div>
                    
                    <div className="space-y-2">
                      <label className="text-sm font-semibold text-stone-700">Image Preview</label>
                      <div className="aspect-[4/5] rounded-xl border-2 border-dashed border-stone-200 bg-stone-50 overflow-hidden flex items-center justify-center relative group">
                        {formData.imageUrl ? (
                          <img 
                            ...
                            referrerPolicy="no-referrer"
                            onError={(e) => {
                              (e.target as HTMLImageElement).src = "https://picsum.photos/seed/error/400/500?blur=2";
                            }}
                          />
                        ) : (
                          <div className="text-center p-4">
                            <ImageIcon className="w-8 h-8 text-stone-300 mx-auto mb-2" />
                            <p className="text-[10px] text-stone-400 uppercase tracking-widest">No Image Provided</p>
                          </div>
                        )}
                      </div>
                    </div>
                  ...
                  <div className="flex items-center gap-3 pt-2">
                    ...
                    />
                    <label htmlFor="isPremium" className="text-sm font-bold text-stone-700 uppercase tracking-widest cursor-pointer">
                      Premium Product
                    </label>
                  </div>
